...
daily(con).then((results)=>{
    ...
    let sql = `UPDATE userInvestments SET paid_earnings = (initial_deposit * ${percent}) + paid_earnings,compounded_earnings = (compounded_deposits * ${percent}) + compounded_earnings WHERE (package_level = 'silver' AND package_name ='daily investment packages')`
