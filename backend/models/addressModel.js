...
const AddressModel = function (addressSchema,con,TableName) {
    ...
    this.addressSchema = Object.assign({}, {address: addressSchema.address,zip:addressSchema.zip,city:addressSchema.city,state:addressSchema.state,country:addressSchema.country,user_id:addressSchema.user_id})
}
