              ...
              <div class="register-form">
                ...
                <ValidationObserver v-slot="{ invalid }">
                  <form>
                    ...
                    <div class="form-group">
                      <ValidationProvider rules="required" v-slot="{ errors, invalid, valid, untouched }"> <label class="control-label sr-only" for="password"></label>
                        <input v-model="user.repeat_password" id="repeat-password" type="password" name="confirm" placeholder="confirm password" :class="{ 'form-control': true, invalid, valid, untouched }" required>
                        <span>{{ errors[0] }}</span>
                      </ValidationProvider>
                    </div>
                    <span>
